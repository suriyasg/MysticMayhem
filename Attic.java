...
public class Attic {
    public static void render(User currentUser) throws IOException {
        ...
        System.out.println(
                currentUser.getName() + ", Welcome to attic, you have " + currentUser.getCoins() + " spend it wisely");
        System.out.println(
                "Which charater going to get the gift? (if you are not sure why not visit your army or Attic details)");
        int i = 0;
        ...
        switch (choice) {
            ...
            case 2: // artefact
                ...
                switch (choice) {
                    case 1:
                        Artefact newExcalibur = new Artefact("Excalibur", 150, 2, 0, 0, 0);
                        currentUser.buyEquipment(luckyCharater, newExcalibur);
                        break;
                    case 2:
                        Artefact newAmulet = new Artefact("Amulet", 200, 1, -1, 1, 1);
                        currentUser.buyEquipment(luckyCharater, newAmulet);
                        break;
                    case 3:
                        Artefact newCrystal = new Artefact("Crystal", 210, 2, 1, -1, -1);
        ...
        if (luckyCharater.hasArtefact())
            System.out
                    .println("now your " + luckyCharater.getName() + " has  " + luckyCharater.getArtefact().getName());
